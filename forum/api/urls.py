...
from .views import ArticleDetailPubApiView,ArticleApiView,ArticleDetailApiView,CommentApiView,CommentDetailApiView
urlpatterns = [
    ...
    url(r'^article/pi$', ArticleDetailPubApiView.as_view()),
